...
data = pd.read_csv("D:\\work\\Python\\python_for_edureka_doc\\Module_9\\run_or_walk.csv")
data.head()
...
print("\nAccuracy Score\n")
print(metrics.accuracy_score(predicted_values_a, test_y_a)*100)
...
print("\nAccuracy Score\n")
print(metrics.accuracy_score(predicted_values_g, test_y_g)*100)
