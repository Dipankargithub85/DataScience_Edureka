...
img = Image.open("D:\\work\\Python\\python_for_edureka_doc\\Module_10\\dogs.jpeg")
...
print("=======================================================================================")
# Plot cluster points
sns.lmplot('col1', 'col2', data=df, hue="cluster",palette='coolwarm', height=6, aspect=1, fit_reg=False)
